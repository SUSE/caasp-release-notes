...
* cilium-init:1.6.6 does not exist in registry link:https://bugzilla.suse.com/show_bug.cgi?id=1172270[bsc#1172270]: you can ignore this error cause cilium-init was deprecated
