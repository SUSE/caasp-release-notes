...
* Added link:{docurl}caasp-deployment/#_networking_whitelist[Networking Whitelist] to deployment guide requirements.
* Restructured the link:{docurl}caasp-admin/#_cluster_disaster_recovery[Disaster Recovery] chapter.
* Added instruction for link:{docurl}caasp-deployment/#cluster.bootstrap.vcp[vSphere Cloud Provider Integration].
