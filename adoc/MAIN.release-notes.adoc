...
Kubernetes release shipped in CaaSP is now 1.16.
More than 31 enhancements were merged in the kubernetes release 1.16
(https://kubernetes.io/blog/2019/09/18/kubernetes-1-16-release-announcement/).

Custom Resources Definitions (CRD) are out of beta, and
are now generally available in the ``apiextensions.k8s.io/v1`` group.

IPv4/IPv6 dual stack is now officially in alpha in 1.16.
...
==== Update your kubernetes manifests for kubernetes 1.16
