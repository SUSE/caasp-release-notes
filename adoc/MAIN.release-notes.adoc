...
4.2.0 brings in a kubernetes update, precisely to 1.17. The list of features and bug fixes is long, see:
...
- Remove ability to re-enable serving deprecated APIs: extensions/v1beta1, apps/v1beta1, and apps/v1beta2 types. See more at https://github.com/kubernetes/kubernetes/issues/43214
