...
Current beta release allows to upgrade from previous {productname} 4.0.0 Beta 3 to
...
CaaSP can be installed as an extension on top of that. Because SLES 15 is
