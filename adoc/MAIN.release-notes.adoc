...
These release notes are updated periodically. The latest version is always available at https://susedoc.github.io/caasp-release-notes/beta/release-notes/single-html/.
//For public release change to: https://documentation.suse.com/suse-caasp/4/.
...
//For public release change to: https://www.suse.com/releasenotes.
...
Find an example load balancer configuration
