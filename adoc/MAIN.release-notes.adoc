...
* Added link:{docurl}single-html/caasp-deployment/caasp-deployment.html#aws-iam-profile-cli[instructions how to manually create AWS IAM role/role policy/instance profile through AWS CLI].
