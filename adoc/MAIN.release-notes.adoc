...
//For public release change to: https://www.suse.com/releasenotes or https://documentation.suse.com/suse-caasp/4/.
...
. You must update the gangway image in your cluster manually. Refer to: <<gangway-update>>.
...
+
====
sudo crictl rmi <gangway-image-id>
====
