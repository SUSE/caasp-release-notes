...
[WARNING]
====
This is an incremental update, you must have the updates for version `4.0.1` installed and
have performed the gangway update. If you install 4.0.2 without applying the gangway update,
all your dex and gangway settings will be erased!
