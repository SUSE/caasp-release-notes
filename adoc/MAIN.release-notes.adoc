...
On top of that, helm has been updated to fix a security issue (CVE-2019-18658) and supporconfig has been updated to gather more support data (bsc#1152335).
...
==== Supportconfig update instructions

Supportconfig update should be installed as a base os update in the nodes:

https://documentation.suse.com/suse-caasp/4.0/html/caasp-admin/_cluster_updates.html#_base_os_updates


==== helm update instructions

Update helm on your management workstation as you would do with any other package.
                                                                                
Refer to: link:https://documentation.suse.com/sles/15-SP1/single-html/SLES-admin/#sec-zypper-softup[{sls} 15 SP1 Admin Guide: Updating Software with Zypper]

=== Bugs Fixed in 4.1.0 since 4.0.3

* link:https://bugzilla.suse.com/show_bug.cgi?id=1144065[cri-o] - (CVE-2019-10214) VUL-0: CVE-2019-10214: libcontainers-common: library does not enforce TLS connections
* link:https://bugzilla.suse.com/show_bug.cgi?id=1118898[cri-o] - (CVE-2018-16874) VUL-0: CVE-2018-16874: go: cmd/go: directory traversal
* link:https://bugzilla.suse.com/show_bug.cgi?id=1100838[cri-o] - cri-o does not block /proc/acpi pathnames (i.e., also affected by CVE-2018-10892) 
* link:https://bugzilla.suse.com/show_bug.cgi?id=1118897[etcd] - (CVE-2018-16873) VUL-0: CVE-2018-16873: go: cmd/go: remote command execution
* link:https://bugzilla.suse.com/show_bug.cgi?id=1118899[etcd] - (CVE-2018-16875) VUL-0: CVE-2018-16875: go: crypto/x509: CPU denial of service
* link:https://bugzilla.suse.com/show_bug.cgi?id=1156646[helm] - (CVE-2019-18658) VUL-0: CVE-2019-18658: helm: commands that deal with loading a chart as a directory or packaging a chart provide an opportunity for a maliciously designed chart to include sensitive content such as /etc/passwd
* link:https://bugzilla.suse.com/show_bug.cgi?id=1152861[kubernetes] - (CVE-2019-11253) VUL-0: CVE-2019-11253: kubernetes: YAML parsing vulnerable to "Billion Laughs" attack, allowing for remote denial of service
* link:https://bugzilla.suse.com/show_bug.cgi?id=1146991[kubernetes] - BPF filesystem is not mounted, possible downtime when cilium pods are restarted
* link:https://bugzilla.suse.com/show_bug.cgi?id=1147142[kubernetes] - Update golang/x/net dependency to bring in fixes for CVE-2019-9512, CVE-2019-9514
* link:https://bugzilla.suse.com/show_bug.cgi?id=1143813[kubernetes] - kubelet sometimes starting too fast
* link:https://bugzilla.suse.com/show_bug.cgi?id=1155810[skuba] - CaaSP SSL / PKI / CA Infrastructure unclear and probably inconsistent and wrong?
* link:https://bugzilla.suse.com/show_bug.cgi?id=1152335[supportutils-plugin-suse-caasp] - supportconfig adjustments for CaaSP v4 missing
