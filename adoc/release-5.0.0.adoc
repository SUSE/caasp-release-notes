...
You can find a list of changes directly relevant to {productname} here: link:{docurl}/single-html/caasp-admin/caasp-admin.html#k8s-changes-117-118[Changes from {kube} 1.17 to 1.18]
