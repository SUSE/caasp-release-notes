...
Note the version of etcd shipped with CaaSP 4.5.0 contains two security issue identified as CVE-2020-15106 and CVE-2020-15112
...
These are "Denial of Service" kind, and a fix for them will be provided as a maintenance update.
